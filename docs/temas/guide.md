...
- **Referencia:** `public/images/referencias/??-guide.webp` (mirarla SIEMPRE: réplica, no «inspirado en»)
- **Colección:** `src/collections/guide.ts` — nombre de tienda confirmado por Andreu: ☐
- **Catálogo:** N productos (reparto de ROADMAP § 9B.0) · slugs `gui-*`
