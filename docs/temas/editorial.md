# Tema editorial — ficha de entrega
...
- **Referencia:** `public/images/referencias/??-editorial.webp` (mirarla SIEMPRE: réplica, no «inspirado en»)
- **Colección:** `src/collections/editorial.ts` — nombre de tienda confirmado por Andreu: ☐
- **Catálogo:** N productos (reparto de ROADMAP § 9B.0) · slugs `edi-*`
