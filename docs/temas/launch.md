...
- **Referencia:** `public/images/referencias/??-launch.webp` (mirarla SIEMPRE: réplica, no «inspirado en»)
- **Colección:** `src/collections/launch.ts` — nombre de tienda confirmado por Andreu: ☐
- **Catálogo:** N productos (reparto de ROADMAP § 9B.0) · slugs `lau-*`
