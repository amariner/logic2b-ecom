...
- **Referencia:** `public/images/referencias/??-minimal.webp` (mirarla SIEMPRE: réplica, no «inspirado en»)
- **Colección:** `src/collections/minimal.ts` — nombre de tienda confirmado por Andreu: ☐
- **Catálogo:** N productos (reparto de ROADMAP § 9B.0) · slugs `min-*`
