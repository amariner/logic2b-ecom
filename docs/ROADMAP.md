...
| 13 | Plataforma modular: del gestor mínimo a paridad extrema de capacidad | 🟡 En curso | 2026-08-14 | **R0, R1, R2.1–R2.14, Admin V2 y R3.1–R3.5 completos; siguiente R3.6:** ubicaciones. Fuente de verdad en [`docs/plataforma/`](plataforma/README.md). |
...
| R3.6+ | Operación profesional y resto de olas | ⬜ siguiente: ubicaciones |
...
### R3.6 — ubicaciones — ⬜ siguiente bloque

R3.5 queda cerrado con selección congelada de hasta 500 pedidos, dry-run puro,
migración expand-only `0018`, job durable en chunks de 25, resultados por fila,
replay/reanudación segura, backup esquema 12 y demo sin efectos. La autorización
de migraciones quedó registrada el 2026-08-14.

Siguiente incremento exacto: diseñar el modelo de almacenes/tiendas y la
compatibilidad con el ledger global existente; elegir una ubicación principal
determinista, proponer el backfill del inventario simple y cerrar primero el ADR
y rehearsal. No se adelantan transferencias de R3.7 ni reglas de asignación de
R3.9. El carril de temas continúa independiente y queda fuera de este objetivo.
