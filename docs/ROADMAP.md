...
| 13 | Plataforma modular: del gestor mínimo a paridad extrema de capacidad | 🟡 En curso | 2026-08-14 | **R0, R1, R2.1–R2.14, Admin V2 y R3.1–R3.6 completos localmente; siguiente R3.7:** transferencias. Fuente de verdad en [`docs/plataforma/`](plataforma/README.md). |
...
| R3.7+ | Operación profesional y resto de olas | ⬜ siguiente: transferencias |
...
### R3.7 — transferencias — ⬜ siguiente bloque

R3.6 queda cerrado con D1 remota `0019`, ubicación principal compatible,
backfill íntegro del ledger global, admin auditado, backup esquema 13 y demo sin
efectos. El despliegue del Worker que sirve R3.5–R3.6 requiere permiso específico
de producción.

Siguiente incremento exacto: transferencias con borrador, envío, recepción
parcial, discrepancias y movimientos compensados entre ubicaciones. No se
adelantan conteos R3.8 ni reglas de asignación R3.9. El carril de temas continúa
