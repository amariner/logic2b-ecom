...
| 13 | Plataforma modular: del gestor mínimo a paridad extrema de capacidad | 🟡 En curso | 2026-08-10 | **R0, R1 y R2.1–R2.5 completos:** galería y atributos tipados auditados, migración `0008`, backup v3 y producción verificada. Siguiente: Admin V2 antes de R2.6; stock sigue global hasta R2.7. Fuente de verdad en [`docs/plataforma/`](plataforma/README.md). |
...
| UIA.1–UIA.4 | Panel administrativo V2 | ⬜ siguiente bloque antes de R2.6 |
| R2.6+ | Ledgers y resto de olas | ⬜ ver plan maestro |
