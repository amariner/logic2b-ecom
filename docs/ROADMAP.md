...
| 13 | Plataforma modular: del gestor mínimo a paridad extrema de capacidad | 🟡 En curso | 2026-08-11 | **R0, R1, R2.1–R2.12 y Admin V2 completos:** inventario, reservas, pagos, reembolso total y fulfillment parcial/múltiple con ledgers reversibles. Siguiente: cancelación/reembolso parcial R2.13. Fuente de verdad en [`docs/plataforma/`](plataforma/README.md). |
