...
| [0042](0042-autenticacion-passwordless-revocable.md) | Challenge de un uso y sesión opaca, rotatoria, revocable y anti-enumeración | accepted; local persistence implemented, surface implementation pending |
| [0043](0043-superficie-passwordless-email-segura.md) | Magic link por Resend directo, origen/cookie/CSRF/CSP, rate limit y recuperación segura | accepted; core/manifest hardened, provider and HTTP pending |
