...
| [0042](0042-autenticacion-passwordless-revocable.md) | Challenge de un uso y sesión opaca, rotatoria, revocable y anti-enumeración | accepted; local persistence implemented, provider and surfaces pending |
