...
| CUS-007 | Consentimientos por canal/finalidad | núcleo | P1 | parcial | ADR, dominio y puerto modelan evidencia append-only, canal/finalidad, aviso versionado, fuente, región, retirada, reconsentimiento e idempotencia; DDL, captura y política legal esperan gates propios. |
