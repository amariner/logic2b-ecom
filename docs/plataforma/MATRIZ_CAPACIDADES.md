...
| CUS-009 | Segmentos calculados | módulo | P2 | especificado | ADR-0045 y contrato R5.6a: facts ausentes `null`, lenguaje limitado, templates/instancias versionados e inmutables, parámetros exactos y lifecycle observable fail-closed. R5.6a.1 (2026-09-18) endurece formas/tipos/campos, evaluación completa, reloj y lifecycle con 54 regresiones focales. Persistencia R5.6b propuesta, pendiente de autorización local; job, rutas y UI conservan gates propios. Demo visual pendiente. |
