...
| CUS-004 | Historial y seguimiento de pedidos | módulo | P2 | especificado | ADR-0044 exige `customer:orders:read`, referencia opaca y owner exacto del perfil; persistencia, reader y superficie siguen pendientes. |
