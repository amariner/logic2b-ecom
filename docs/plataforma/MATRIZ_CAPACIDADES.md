...
| CUS-009 | Segmentos calculados | módulo | P2 | parcial | ADR-0045, lenguaje/templates estrictos y persistencia local R5.6b: 0045, hechos congelados, CAS, reintentos históricos, publicaciones versionadas y backup 38. Restore D1 con guardas activas y 126 tablas idénticas; 210 suites/1.261 tests y E2E verdes (2026-09-18). Instalada/inactiva; política y productor real de hechos, jobs, rutas, UI y rollout conservan sus bloques y gates. Demo visual pendiente. |
