...
| CUS-004 | Historial y seguimiento de pedidos | módulo | P2 | parcial | ADR-0044, D1 `0041`, backup 34 y `GET /api/customer/orders/:ord_ref` implementan referencia aleatoria/versionada, owner canónico, sesión/capability/scope exactos, DTO mínimo, rate limit y 404 IDOR uniforme sin reclamar historia guest. Permanece instalado e inactivo: índice, UI, navegación y rollout siguen pendientes. |
