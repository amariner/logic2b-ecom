...
export const BACKUP_SCHEMA_VERSION = 35;
...
export function buildBackupSql(tablesRows: Record<string, Row[]>, generatedAt: string): string {
  const lines = [
    ...
    '-- Requiere una base con la migración 0042_customer_address_access aplicada; las tablas/columnas explícitas abortan un restore incompatible.',
