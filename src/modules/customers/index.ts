...
export {
  ...
  CUSTOMER_SEGMENT_OPERATORS,
  CUSTOMER_SEGMENT_RECALCULATION_STATES,
  ...
  type CalculatedCustomerSegment,
  type CustomerSegmentCondition,
  type CustomerSegmentEvaluation,
  type CustomerSegmentFact,
  type CustomerSegmentFacts,
  type CustomerSegmentOperator,
  type CustomerSegmentParameter,
