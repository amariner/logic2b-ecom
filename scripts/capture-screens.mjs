...
const STORES = [
  { id: 'arista', label: 'ARISTA', catalog: '/demo/tiendas/arista', full: true, maxH: 3600, desktopQ: 66, mobileQ: 56 },
  { id: 'eje', label: 'EJE', catalog: '/demo/tiendas/eje', full: true, maxH: 3600, desktopQ: 66, mobileQ: 56 },
  { id: 'ensamble', label: 'ENSAMBLE', catalog: '/demo/tiendas/ensamble', full: true, maxH: 3600, desktopQ: 66, mobileQ: 56 },
...
const FICHAS = [
  { id: 'arista', slug: 'ari-duo-muro', prefix: '/demo/tiendas/arista' },
  { id: 'eje', slug: 'eje-silla-torno', prefix: '/demo/tiendas/eje' },
  { id: 'ensamble', slug: 'ens-mesa-umbral', prefix: '/demo/tiendas/ensamble' },
