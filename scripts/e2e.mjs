...
check(
  'backup esquema 31 conserva operación, clientes, consentimientos, RMA, pricing, modelos de venta y presupuestos',
  backupSql.includes('logic2b-backup-schema: 31')
    ...
    && backupSql.includes('0037_consent_evidence')
