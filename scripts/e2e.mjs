...
check(
  'backup esquema 30 conserva operación, clientes, RMA, pricing, modelos de venta y presupuestos',
  backupSql.includes('logic2b-backup-schema: 30')
    ...
    && backupSql.includes('0036_customer_profiles')
