...
check(
  'backup esquema 32 conserva operación, clientes, consentimientos, derechos, RMA, pricing, modelos de venta y presupuestos',
  backupSql.includes('logic2b-backup-schema: 32')
    ...
    && backupSql.includes('0038_data_rights_evidence')
