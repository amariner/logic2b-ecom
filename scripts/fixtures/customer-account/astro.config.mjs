...
const returnRuntimeFixture = fileURLToPath(new URL('./runtime-customer-returns.ts', import.meta.url));
const alias = [];
...
if (mode === 'surface') {
  alias.push(
    ...
    { find: './composition/runtime-customer-returns', replacement: returnRuntimeFixture },
